          ...
          <div className="projects-wrapper clearfix">
            <div className="container">
              <div className="projects-container column-projects">
                ...
                <div className="col-md-4 col-sm-6 project development image-holder">
                  <div className="background-image-holder">
                    <img className="background-image" alt="Background Image" src="./Assets/img/project_6.jpg" />
                  </div>
                  <div className="hover-state">
                    <div className="align-vertical">
                      <h3 className="text-white">Revive Hair & Beauty, Auckland</h3>
                      <a href="http://www.revivebeautyhair.co.nz/" target="_blank" className="btn btn-primary btn-white">
                        See Project
                      </a>
                    </div>
                  </div>
                ...
                <div className="col-md-4 col-sm-6 project development image-holder">
                  ...
                  <div className="hover-state">
                    <div className="align-vertical">
                      ...
                      <a href="http://www.plumbfirst.co.nz/" target="_blank" className="btn btn-primary btn-white">
                        See Project
                      </a>
                    </div>
                  </div>
            ...
            <div className="row">
              <div className="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 text-center">
                ...
                <h1>
                  ...
                  <br />
                  <span className="sub alt-font">I am looking for full time job!</span>
                </h1>
