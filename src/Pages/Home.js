          ...
          <div className="container">
            <div className="row">
              <div className="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
                <h1>My skills</h1>
                <p className="lead">
                  A highly experienced and creative web developer with two years of experience in a variety of exciting projects. A level head and rational approach to problem solving combined with a
                  passion for innovative and fresh ideas has led to a portfolio of impressive website solutions.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-12">
                <div className="skills-right skills" style={{ textAlign: "initial" }}>
                  <h3>Developing</h3>
                  <ul className="skills-ul">
                    <li>
                    ...
                    <li>
                      <span>Working knowledge of AWS, Microsoft Azure, and basic testing tools</span>
                      <div className="skill-bar-holder">
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
                ...
                <p className="lead">
                  With a varies experience in website development , graphics desing and sign installation. Please have a look below to see some of the completed projects while working in A1 Solutions,
                  Auckland.
                </p>
              </div>
            </div>
              ...
              <div className="col-md-6 col-sm-12 no-pad project print image-holder">
                ...
                <div className="hover-state">
                  <div className="align-vertical">
                    ...
                    <p className="text-white">Auckland based Demolition&nbsp;Waste Removal company</p>
                    <a href="http://wastex.co.nz" target="_blank" className="btn btn-primary btn-white">
                      See Project
                    </a>
                  </div>
                </div>
              ...
              <div className="col-sm-12">
                <div className="timeline-event">
                  ...
                  <div className="col-sm-6 col-md-pull-6">
                    <p>
                      To carry out design of customer signage orders to the framework & guidelines of Powerpac's design & file system, ensure the print production team has all relevant files, jobs &
                      information prior to work.
                      <br />
                      <b>#Customer Chasing #Quote #Invoicing #Completion of Job #Stock Management #Stock Order #Meeting with Sales visitors.</b>
                    </p>
                  </div>
                </div>
                <div className="timeline-event">
                  ...
                  <div className="col-sm-6">
                    <p>
                      Manage the RIP (Raster Image Processor) phase of Torque Digital's print production with an accurate and timely approach and ensure all roles involved in the process are
                ...
                <div className="timeline-event">
                  ...
                  <div className="col-sm-6 col-md-pull-6">
                    <p>
                      Joined as an intern and promoted rapidly through a series of increasingly responsible role as a website designer and developer, Responsible for participating in the full life
                      cycle of new website development projects, and for implement and maintaining best practice procedures in all areas of work. Also in charge of writing, developing and managing the
                      content of websites.
                    </p>
                  </div>
                </div>
